...
define('services/common',["durandal/system","durandal/app","knockout","services/logger"],function(){return{blogUrl:"/blog/feed/",photoUrl:"/photos/feed/",blogPartialStreamCount:10,photosPartialStreamCount:3,initializeLazyLoad:function(){$("img.lazy").lazyload({effect:"fadeIn"})},initializeFancyBox:function(){$(".fancybox-thumb").fancybox({prevEffect:"none",nextEffect:"none",helpers:{title:{type:"outside"},thumbs:{width:50,height:50}}})}}});
define('services/photostream',["durandal/system","durandal/app","knockout","services/logger"],function(e,t,n){function i(e,t,n){if(r().length>0)return t(),void 0;r.removeAll(),a.removeAll();var i={url:e,type:"GET",async:!0,dataType:"xml"};$.ajax(i).done(function(e){var n=$(e);n.find("item").each(function(){var e="",t=$(this);({cat:t.find("category").each(function(){e+=" "+$(this).text().toLowerCase()})});var n=$(this).find("thumb"),i=$(this).find("original"),a=$(this),o={title:a.find("title").text(),link:a.find("link").text(),description:a.find("description").text(),categories:e,pubDate:a.find("pubDate").text(),author:a.find("author").text(),thumbUrl:n.text(),thumbHeight:n.attr("height"),thumbWidth:n.attr("width"),originalUrl:i.text(),originalHeight:i.attr("height"),originalWidth:i.attr("width")};r().push(o)});for(var i=0;3>i&&i<r().length;i++)a().push(r()[i]);t()}).fail(function(){n()})}var r=n.observableArray([]),a=n.observableArray([]),o={stream:r,partialStream:a,load:i};return o});
