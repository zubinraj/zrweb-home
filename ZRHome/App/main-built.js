...
define('viewmodels/blog',["plugins/http","knockout","services/logger","services/blogstream","services/common"],function(t,e,n,i,r){function a(){l(),i.load(r.blogUrl,o,s);var t=$("#blog-container");$("#blog .filters a").click(function(){var e=$(this).attr("data-filter");return t.isotope({filter:e}),$(this).toggleClass("selected"),$("#blog .filters a").not(this).removeClass("selected"),!1})}function o(){c(i.stream()),$("#blog-loading").hide()}function s(){n.logError("Data didn't load as expected. Please try again.",null,!0),$("#blog-loading").hide()}function l(){e.bindingHandlers.isotope={init:function(){},update:function(t,n){var i=$(t),r=e.utils.unwrapObservable(n()),a=$(r.container);a.isotope({itemSelector:r.itemSelector}),a.isotope("appended",i)}}}var c=e.observableArray([]),u={title:"Zubin's Web Log",items:c,compositionComplete:a};return u});
