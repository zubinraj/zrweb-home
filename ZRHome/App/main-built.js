...
define('viewmodels/contact',["services/logger"],function(){function e(){}var t={title:"Contact",contactHeading:"Any questions?",contactItems:[{channel:"email",text:"support @ zubinraj dot com",url:""},{channel:"twitter",text:"@zubinraj",url:"https://twitter.com/zubinraj"},{channel:"github",text:"https://github.com/zubinraj/",url:"https://github.com/zubinraj/"}],licenseHeading:"License",licenseText:'Photos, source code and articles published on this website, that are not explicitly mentioned otherwise, are licensed under <a  target="_blank" href="http://creativecommons.org/licenses/by-nc/3.0/deed.en_US">Creative Commons Attribution-NonCommercial 3.0 Unported</a> license. See <a href="#license/">here</a> for more information and details about <a href="#license/">third party licenses</a> used in this website.',disclaimerHeading:"Disclaimer",disclaimerText:'Any source code and opinions provided in this website is provided "as-is" and does not have any warranty or support. However, if you have a question, you can always contact me through the aforementioned channels. The opinions expressed herein are my own personal opinions and do not represent my employer’s view in any way.',activate:e};return t});
define('viewmodels/error',["plugins/http","knockout","services/logger"],function(e,t){function n(e){"404"==e?i():r()}function i(){console.log("404 error"),o.title("Not Found"),o.msg("The resource you are requesting has either moved or is unavailable."+a)}function r(){console.log("default error"),o.title("Error"),o.msg("Oops! Something bad just happened."+a)}var a=' Please try again or go to the <a href="#">home page</a>.',o={title:t.observable(),msg:t.observable(),activate:n};return o});
define('viewmodels/flickr',["plugins/http","durandal/app","knockout"],function(e,t,n){return{title:"Photography",images:n.observableArray([]),activate:function(){if(!(this.images().length>0)){var t=this;return e.jsonp("http://api.flickr.com/services/feeds/photos_public.gne",{id:"9347697@N03",tags:"bird",tagmode:"all",format:"json"},"jsoncallback").then(function(e){t.images(e.items)})}},select:function(e){e.viewUrl="views/detail",t.showDialog(e)}}});
define('viewmodels/license',["services/logger"],function(){function e(){}var t={title:"License",description:'Photos, source code and articles published on this website, that are not explicitly mentioned otherwise, are licensed under <a target="_blank" href="http://creativecommons.org/licenses/by-nc/3.0/deed.en_US">Creative Commons Attribution-NonCommercial 3.0 Unported</a> license.',creativeCommons:'<a rel="license" target="_blank" href="http://creativecommons.org/licenses/by-nc/3.0/deed.en_US"><img alt="Creative Commons License" style="border-width:0" src="http://i.creativecommons.org/l/by-nc/3.0/88x31.png" /></a>',terms:[{term:"Attribution"},{term:"Non-Commercial"}],descriptionLine1:"If any section of this website mentions it's own licensing terms, that will override the terms mentioned here.",commercialHeading:"Commercial",commercialText:'If you want a higher quality photo published on this website for commercial use, please <a href="#contact">contact me</a>.',thirdPartyHeading:"Third Party Licenses",thirdPartyItems:[{library:"Durandal JS",license:"MIT",url:"https://raw.github.com/BlueSpire/Durandal/master/License.txt"},{library:"Knockout JS",license:"MIT",url:"https://github.com/knockout/knockout#license"},{library:"Bootstrap",license:"Apache",url:"https://github.com/twbs/bootstrap/blob/master/LICENSE"},{library:"Isotope",license:"MIT / Commercial",url:"http://isotope.metafizzy.co/docs/license.html"},{library:"Require JS",license:'MIT / "New" BSD',url:"https://github.com/jrburke/requirejs/blob/master/LICENSE"},{library:"Lazy Load Plugin for JQuery",license:"MIT",url:"https://github.com/tuupola/jquery_lazyload#license"},{library:"fancyBox",license:"MIT",url:"http://www.fancyapps.com/fancybox/#license"}],activate:e};return t});
define('viewmodels/photos',["plugins/http","knockout","services/logger"],function(e,t){function n(){var e=$("#gallery-container");e.isotope("reLayout"),$("img.lazy").lazyload({effect:"fadeIn"}),$(document).ready(function(){$(".fancybox-thumb").fancybox({prevEffect:"none",nextEffect:"none",helpers:{title:{type:"outside"},thumbs:{width:50,height:50}}})}),$("#gallery .filters a").click(function(){var t=$(this).attr("data-filter");return e.isotope({filter:t}),$(this).toggleClass("selected"),$("#gallery .filters a").not(this).removeClass("selected"),!1})}function i(){if(!(this.images().length>0)){r();var t=this;return e.get("rss.xml","xml").then(function(e){var n=$(e);n.find("item").each(function(){var e="",n=$(this);({cat:n.find("category").each(function(){e+=" "+$(this).text().toLowerCase()})});var i=$(this).find("thumb"),r=$(this).find("original"),a=$(this),o={title:a.find("title").text(),link:a.find("link").text(),description:a.find("description").text(),categories:e,pubDate:a.find("pubDate").text(),author:a.find("author").text(),thumbUrl:i.text(),thumbHeight:i.attr("height"),thumbWidth:i.attr("width"),originalUrl:r.text(),originalHeight:r.attr("height"),originalWidth:r.attr("width")};t.images.push(o)})})}}function r(){t.bindingHandlers.isotope={update:function(e,n){var i=$(e),r=t.utils.unwrapObservable(n());i.hasClass("isotope")?i.isotope("reLayout"):i.isotope({itemSelector:r.itemSelector})}}}var a={title:"Photography",images:t.observableArray([]),activate:i,compositionComplete:n};return a});
