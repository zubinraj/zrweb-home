...
define('durandal/composition',["durandal/system","durandal/viewLocator","durandal/binder","durandal/viewEngine","durandal/activator","jquery","knockout"],function(e,t,i,n,r,o,a){function c(e){for(var t=[],i={childElements:t,activeView:null},n=a.virtualElements.firstChild(e);n;)1==n.nodeType&&(t.push(n),n.getAttribute(p)&&(i.activeView=n)),n=a.virtualElements.nextSibling(n);return i.activeView||(i.activeView=t[0]),i}function s(){w--,0===w&&setTimeout(function(){for(var e=b.length;e--;)b[e]();b=[]},1)}function l(t,i,n){if(n)i();else if(t.activate&&t.model&&t.model.activate){var r;r=e.isArray(t.activationData)?t.model.activate.apply(t.model,t.activationData):t.model.activate(t.activationData),r&&r.then?r.then(i):r||void 0===r?i():s()}else i()}function u(){var t=this;t.activeView&&t.activeView.removeAttribute(p),t.child&&(t.model&&t.model.attached&&(t.composingNewView||t.alwaysTriggerAttach)&&t.model.attached(t.child,t.parent,t),t.attached&&t.attached(t.child,t.parent,t),t.child.setAttribute(p,!0),t.composingNewView&&t.model&&(t.model.compositionComplete&&h.current.complete(function(){t.model.compositionComplete(t.child,t.parent,t)}),t.model.detached&&a.utils.domNodeDisposal.addDisposeCallback(t.child,function(){t.model.detached(t.child,t.parent,t)})),t.compositionComplete&&h.current.complete(function(){t.compositionComplete(t.child,t.parent,t)})),s(),t.triggerAttach=e.noop}function d(t){if(e.isString(t.transition)){if(t.activeView){if(t.activeView==t.child)return!1;if(!t.child)return!0;if(t.skipTransitionOnSameViewId){var i=t.activeView.getAttribute("data-view"),n=t.child.getAttribute("data-view");return i!=n}}return!0}return!1}function f(e){for(var t=0,i=e.length,n=[];i>t;t++){var r=e[t].cloneNode(!0);n.push(r)}return n}function v(e){var t=f(e.parts),i=h.getParts(t),n=h.getParts(e.child);for(var r in i)o(n[r]).replaceWith(i[r])}function m(t){var i,n,r=a.virtualElements.childNodes(t);if(!e.isArray(r)){var o=[];for(i=0,n=r.length;n>i;i++)o[i]=r[i];r=o}for(i=1,n=r.length;n>i;i++)a.removeNode(r[i])}var h,g={},p="data-active-view",b=[],w=0,y="durandal-composition-data",A="data-part",I="["+A+"]",S=["model","view","transition","area","strategy","activationData"],D={complete:function(e){b.push(e)}};return h={convertTransitionToModuleId:function(e){return"transitions/"+e},defaultTransitionName:null,current:D,addBindingHandler:function(e,t,i){var n,r,o="composition-handler-"+e;t=t||a.bindingHandlers[e],i=i||function(){return void 0},r=a.bindingHandlers[e]={init:function(e,n,r,c,s){var l={trigger:a.observable(null)};return h.current.complete(function(){t.init&&t.init(e,n,r,c,s),t.update&&(a.utils.domData.set(e,o,t),l.trigger("trigger"))}),a.utils.domData.set(e,o,l),i(e,n,r,c,s)},update:function(e,t,i,n,r){var c=a.utils.domData.get(e,o);return c.update?c.update(e,t,i,n,r):(c.trigger(),void 0)}};for(n in t)"init"!==n&&"update"!==n&&(r[n]=t[n])},getParts:function(t){var i={};e.isArray(t)||(t=[t]);for(var n=0;n<t.length;n++){var r=t[n];if(r.getAttribute){var a=r.getAttribute(A);a&&(i[a]=r);for(var c=o(I,r).not(o("[data-bind] "+I,r)),s=0;s<c.length;s++){var l=c.get(s);i[l.getAttribute(A)]=l}}}return i},cloneNodes:f,finalize:function(t){if(t.transition=t.transition||this.defaultTransitionName,t.child||t.activeView)if(d(t)){var n=this.convertTransitionToModuleId(t.transition);e.acquire(n).then(function(e){t.transition=e,e(t).then(function(){if(t.cacheViews){if(t.activeView){var e=i.getBindingInstruction(t.activeView);void 0==e.cacheViews||e.cacheViews||a.removeNode(t.activeView)}}else t.child?m(t.parent):a.virtualElements.emptyNode(t.parent);t.triggerAttach()})}).fail(function(t){e.error("Failed to load transition ("+n+"). Details: "+t.message)})}else{if(t.child!=t.activeView){if(t.cacheViews&&t.activeView){var r=i.getBindingInstruction(t.activeView);void 0==r.cacheViews||r.cacheViews?o(t.activeView).hide():a.removeNode(t.activeView)}t.child?(t.cacheViews||m(t.parent),o(t.child).show()):t.cacheViews||a.virtualElements.emptyNode(t.parent)}t.triggerAttach()}else t.cacheViews||a.virtualElements.emptyNode(t.parent),t.triggerAttach()},bindAndShow:function(e,t,r){t.child=e,t.composingNewView=t.cacheViews?-1==a.utils.arrayIndexOf(t.viewElements,e):!0,l(t,function(){if(t.binding&&t.binding(t.child,t.parent,t),t.preserveContext&&t.bindingContext)t.composingNewView&&(t.parts&&v(t),o(e).hide(),a.virtualElements.prepend(t.parent,e),i.bindContext(t.bindingContext,e,t.model));else if(e){var r=t.model||g,c=a.dataFor(e);if(c!=r){if(!t.composingNewView)return o(e).remove(),n.createView(e.getAttribute("data-view")).then(function(e){h.bindAndShow(e,t,!0)}),void 0;t.parts&&v(t),o(e).hide(),a.virtualElements.prepend(t.parent,e),i.bind(r,e)}}h.finalize(t)},r)},defaultStrategy:function(e){return t.locateViewForObject(e.model,e.area,e.viewElements)},getSettings:function(t){var i,o=t(),c=a.utils.unwrapObservable(o)||{},s=r.isActivator(o);if(e.isString(c))return c=n.isViewUrl(c)?{view:c}:{model:c,activate:!0};if(i=e.getModuleId(c))return c={model:c,activate:!0};!s&&c.model&&(s=r.isActivator(c.model));for(var l in c)c[l]=-1!=a.utils.arrayIndexOf(S,l)?a.utils.unwrapObservable(c[l]):c[l];return s?c.activate=!1:void 0===c.activate&&(c.activate=!0),c},executeStrategy:function(e){e.strategy(e).then(function(t){h.bindAndShow(t,e)})},inject:function(i){return i.model?i.view?(t.locateView(i.view,i.area,i.viewElements).then(function(e){h.bindAndShow(e,i)}),void 0):(i.strategy||(i.strategy=this.defaultStrategy),e.isString(i.strategy)?e.acquire(i.strategy).then(function(e){i.strategy=e,h.executeStrategy(i)}).fail(function(t){e.error("Failed to load view strategy ("+i.strategy+"). Details: "+t.message)}):this.executeStrategy(i),void 0):(this.bindAndShow(null,i),void 0)},compose:function(i,n,r,o){w++,o||(n=h.getSettings(function(){return n},i));var a=c(i);n.activeView=a.activeView,n.parent=i,n.triggerAttach=u,n.bindingContext=r,n.cacheViews&&!n.viewElements&&(n.viewElements=a.childElements),n.model?e.isString(n.model)?e.acquire(n.model).then(function(t){n.model=e.resolveObject(t),h.inject(n)}).fail(function(t){e.error("Failed to load composed module ("+n.model+"). Details: "+t.message)}):h.inject(n):n.view?(n.area=n.area||"partial",n.preserveContext=!0,t.locateView(n.view,n.area,n.viewElements).then(function(e){h.bindAndShow(e,n)})):this.bindAndShow(null,n)}},a.bindingHandlers.compose={init:function(){return{controlsDescendantBindings:!0}},update:function(e,t,i,r,o){var c=h.getSettings(t,e);if(c.mode){var s=a.utils.domData.get(e,y);if(!s){var l=a.virtualElements.childNodes(e);s={},"inline"===c.mode?s.view=n.ensureSingleElement(l):"templated"===c.mode&&(s.parts=f(l)),a.virtualElements.emptyNode(e),a.utils.domData.set(e,y,s)}"inline"===c.mode?c.view=s.view.cloneNode(!0):"templated"===c.mode&&(c.parts=s.parts),c.preserveContext=!0}h.compose(e,c,o,!0)}},a.virtualElements.allowedBindings.compose=!0,h});
...
define('durandal/app',["durandal/system","durandal/viewEngine","durandal/composition","durandal/events","jquery"],function(e,t,i,n,r){function o(){return e.defer(function(t){return 0==s.length?(t.resolve(),void 0):(e.acquire(s).then(function(i){for(var n=0;n<i.length;n++){var r=i[n];if(r.install){var o=c[n];e.isObject(o)||(o={}),r.install(o),e.log("Plugin:Installed "+s[n])}else e.log("Plugin:Loaded "+s[n])}t.resolve()}).fail(function(t){e.error("Failed to load plugin(s). Details: "+t.message)}),void 0)}).promise()}var a,s=[],c=[];return a={title:"Application",configurePlugins:function(t,i){var n=e.keys(t);i=i||"plugins/",-1===i.indexOf("/",i.length-1)&&(i+="/");for(var r=0;r<n.length;r++){var o=n[r];s.push(i+o),c.push(t[o])}},start:function(){return e.log("Application:Starting"),this.title&&(document.title=this.title),e.defer(function(t){r(function(){o().then(function(){t.resolve(),e.log("Application:Started")})})}).promise()},setRoot:function(n,r,o){var a,s={activate:!0,transition:r};a=!o||e.isString(o)?document.getElementById(o||"applicationHost"):o,e.isString(n)?t.isViewUrl(n)?s.view=n:s.model=n:s.model=n,i.compose(a,s)}},n.includeIn(a),a});
define('services/logger',["durandal/system"],function(t){function n(t,n,e,r){o(t,n,e,r,"info")}function e(t,n,e,r){o(t,n,e,r,"error")}function o(n,e,o,r,i){o=o?"["+o+"] ":"",e?t.log(o,n,e):t.log(o,n),r&&("error"===i?toastr.error(n):toastr.info(n))}var r={log:n,logError:e};return r});
requirejs.config({urlArgs:"version=0.5",paths:{text:"../Scripts/text",durandal:"../Scripts/durandal",plugins:"../Scripts/durandal/plugins",transitions:"../Scripts/durandal/transitions"}}),define("jquery",[],function(){return jQuery}),define("knockout",ko),define('main',["durandal/system","durandal/app","durandal/viewLocator","services/logger"],function(t,n,o){t.debug(!1),n.title="ZUBINRAJ.COM",n.configurePlugins({router:!0,dialog:!0,widget:!0}),n.start().then(function(){toastr.options.positionClass="toast-bottom-right",toastr.options.backgroundpositionClass="toast-bottom-right",o.useConvention(),n.setRoot("viewmodels/shell","entrance")})});
define('services/blogstream',["durandal/system","durandal/app","knockout","services/logger"],function(t,e,n,r){function a(t){i().length>0||$.ajax({url:t,dataType:"xml",success:function(t){var e=$(t);e.find("item").each(function(){var t="",e=$(this);({cat:e.find("category").each(function(){t+=" "+$(this).text().toLowerCase()})});var n=$(this),r={title:n.find("title").text(),link:n.find("link").text(),description:n.find("description").text(),pubDate:n.find("pubDate").text(),author:n.find("author").text(),categories:t};i().push(r)});for(var n=0;10>n&&n<i().length;n++)o().push(i()[n])},error:function(){r.logError("Data didn't load as expected. Please try again.",null,null,!0)}})}var i=n.observableArray([]),o=n.observableArray([]),s={stream:i,partialStream:o,load:a};return s});
define('services/common',["durandal/system","durandal/app","knockout","services/logger"],function(){return{blogUrl:"rss_b.xml",photoUrl:"rss.xml",initializeLazyLoad:function(){$("img.lazy").lazyload({effect:"fadeIn"})},initializeFancyBox:function(){$(".fancybox-thumb").fancybox({prevEffect:"none",nextEffect:"none",helpers:{title:{type:"outside"},thumbs:{width:50,height:50}}})},showLoader:function(){$(".loading").show()},hideLoader:function(){$(".loading").hide()}}});
define('services/photostream',["durandal/system","durandal/app","knockout","services/logger"],function(t,e,n,r){function i(t){a().length>0||$.ajax({url:t,dataType:"xml",success:function(t){var e=$(t);e.find("item").each(function(){var t="",e=$(this);({cat:e.find("category").each(function(){t+=" "+$(this).text().toLowerCase()})});var n=$(this).find("thumb"),r=$(this).find("original"),i=$(this),o={title:i.find("title").text(),link:i.find("link").text(),description:i.find("description").text(),categories:t,pubDate:i.find("pubDate").text(),author:i.find("author").text(),thumbUrl:n.text(),thumbHeight:n.attr("height"),thumbWidth:n.attr("width"),originalUrl:r.text(),originalHeight:r.attr("height"),originalWidth:r.attr("width")};a().push(o)});for(var n=0;3>n&&n<a().length;n++)o().push(a()[n])},error:function(){r.logError("Data didn't load as expected. Please try again.",null,null,!0)}})}var a=n.observableArray([]),o=n.observableArray([]),s={stream:a,partialStream:o,load:i};return s});
...
define('viewmodels/photos',["plugins/http","knockout","services/logger","services/photostream","services/common"],function(e,t,i,n,r){function o(){var e=$("#gallery-container");e.isotope("reLayout"),r.initializeLazyLoad(),r.initializeFancyBox(),$("#gallery .filters a").click(function(){var t=$(this).attr("data-filter");return e.isotope({filter:t}),$(this).toggleClass("selected"),$("#gallery .filters a").not(this).removeClass("selected"),!1}),r.hideLoader()}function a(){s(),n.load(r.photoUrl)}function s(){t.bindingHandlers.isotope={update:function(e,i){var n=$(e),r=t.utils.unwrapObservable(i());n.hasClass("isotope")?n.isotope("reLayout"):n.isotope({itemSelector:r.itemSelector})}}}var l={title:"Ann & Zubin Photography",images:n.stream(),activate:a,compositionComplete:o};return l});
...
define('plugins/observable',["durandal/system","durandal/binder","knockout"],function(e,t,i){function n(e){var t=e[0];return"_"===t||"$"===t}function o(t){if(!t||e.isElement(t)||t.ko===i||t.jquery)return!1;var n=d.call(t);return-1==f.indexOf(n)&&!(t===!0||t===!1)}function r(e,t){var i=e.__observable__,n=!0;if(!i||!i.__full__){i=i||(e.__observable__={}),i.__full__=!0,h.forEach(function(i){e[i]=function(){n=!1;var e=m[i].apply(t,arguments);return n=!0,e}}),v.forEach(function(i){e[i]=function(){n&&t.valueWillMutate();var o=g[i].apply(e,arguments);return n&&t.valueHasMutated(),o}}),p.forEach(function(i){e[i]=function(){for(var o=0,r=arguments.length;r>o;o++)a(arguments[o]);n&&t.valueWillMutate();var s=g[i].apply(e,arguments);return n&&t.valueHasMutated(),s}}),e.splice=function(){for(var i=2,o=arguments.length;o>i;i++)a(arguments[i]);n&&t.valueWillMutate();var r=g.splice.apply(e,arguments);return n&&t.valueHasMutated(),r};for(var o=0,r=e.length;r>o;o++)a(e[o])}}function a(t){var a,s;if(o(t)&&(a=t.__observable__,!a||!a.__full__)){if(a=a||(t.__observable__={}),a.__full__=!0,e.isArray(t)){var l=i.observableArray(t);r(t,l)}else for(var u in t)n(u)||a[u]||(s=t[u],e.isFunction(s)||c(t,u,s));b&&e.log("Converted",t)}}function s(e,t,i){var n;e(t),n=e.peek(),i?n.destroyAll||(n||(n=[],e(n)),r(n,e)):a(n)}function c(t,n,o){var c,l,u=t.__observable__||(t.__observable__={});if(void 0===o&&(o=t[n]),e.isArray(o))c=i.observableArray(o),r(o,c),l=!0;else if("function"==typeof o){if(!i.isObservable(o))return null;c=o}else e.isPromise(o)?(c=i.observable(),o.then(function(t){if(e.isArray(t)){var n=i.observableArray(t);r(t,n),t=n}c(t)})):(c=i.observable(o),a(o));return Object.defineProperty(t,n,{configurable:!0,enumerable:!0,get:c,set:i.isWriteableObservable(c)?function(t){t&&e.isPromise(t)?t.then(function(t){s(c,t,e.isArray(t))}):s(c,t,l)}:void 0}),u[n]=c,c}function l(t,i,n){var o,r=this,a={owner:t,deferEvaluation:!0};return"function"==typeof n?a.read=n:("value"in n&&e.error('For ko.defineProperty, you must not specify a "value" for the property. You must provide a "get" function.'),"function"!=typeof n.get&&e.error('For ko.defineProperty, the third parameter must be either an evaluator function, or an options object containing a function called "get".'),a.read=n.get,a.write=n.set),o=r.computed(a),t[i]=o,c(t,i,o)}var u,d=Object.prototype.toString,f=["[object Function]","[object String]","[object Boolean]","[object Number]","[object Date]","[object RegExp]"],h=["remove","removeAll","destroy","destroyAll","replace"],v=["pop","reverse","sort","shift","splice"],p=["push","unshift"],g=Array.prototype,m=i.observableArray.fn,b=!1;return u=function(e,t){var n,o,r;return e?(n=e.__observable__,n&&(o=n[t])?o:(r=e[t],i.isObservable(r)?r:c(e,t,r))):null},u.defineProperty=l,u.convertProperty=c,u.convertObject=a,u.install=function(e){var i=t.binding;t.binding=function(e,t,n){n.applyBindings&&!n.skipConversion&&a(e),i(e,t)},b=e.logConversion},u});
